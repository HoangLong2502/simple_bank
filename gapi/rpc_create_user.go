...
import (
	...
	"github.com/HoangLong2502/simple_bank/validate"
	"github.com/lib/pq"
...
func (server *ServerRGPC) CreateUser(ctx context.Context, req *pb.CreateUserRequest) (*pb.CreateUserResponse, error) {
